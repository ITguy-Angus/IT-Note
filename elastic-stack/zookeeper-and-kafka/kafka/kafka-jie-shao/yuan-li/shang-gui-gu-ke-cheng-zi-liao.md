...
![](https://gitee.com/jallenkwong/LearnKafka/raw/master/image/01.png)
...
![](https://gitee.com/jallenkwong/LearnKafka/raw/master/image/02.png)
...
![](https://gitee.com/jallenkwong/LearnKafka/raw/master/image/03.png)

### 05.Kafka入门\_基础架构

![](https://gitee.com/jallenkwong/LearnKafka/raw/master/image/04.png)
...
下载[kafka 0.11.0.0](https://www.oschina.net/action/GoToLink?url=https%3A%2F%2Farchive.apache.org%2Fdist%2Fkafka%2F0.11.0.0%2Fkafka_2.11-0.11.0.0.tgz)版本，解压到`C:\Kafka\`路径下，Kafka主目录文件为`C:\Kafka\kafka_2.11-0.11.0.0`（下文用KAFKA\_HOME表示）。
...
![](https://gitee.com/jallenkwong/LearnKafka/raw/master/image/05.png)
...
![](https://gitee.com/jallenkwong/LearnKafka/raw/master/image/06.png)
...
![](https://gitee.com/jallenkwong/LearnKafka/raw/master/image/07.png)
...
![](https://gitee.com/jallenkwong/LearnKafka/raw/master/image/08.png)
...
![](https://gitee.com/jallenkwong/LearnKafka/raw/master/image/09.png)
...
![](https://gitee.com/jallenkwong/LearnKafka/raw/master/image/10.png)
...
![](https://gitee.com/jallenkwong/LearnKafka/raw/master/image/11.png)
...
![](https://gitee.com/jallenkwong/LearnKafka/raw/master/image/12.png)
...
![](https://gitee.com/jallenkwong/LearnKafka/raw/master/image/16.png)
...
![](https://gitee.com/jallenkwong/LearnKafka/raw/master/image/17.png)
...
![](https://gitee.com/jallenkwong/LearnKafka/raw/master/image/18.png)
...
### 20.Kafka高级\_消费者offset的存储

由于 consumer 在消费过程中可能会出现断电宕机等故障， consumer 恢复后，需要从故障前的位置的继续消费，所以 **consumer 需要实时记录自己消费到了哪个 offset**，以便故障恢复后继续消费。

![](https://gitee.com/jallenkwong/LearnKafka/raw/master/image/13.png)
...
![](https://gitee.com/jallenkwong/LearnKafka/raw/master/image/14.png)
...
![](https://gitee.com/jallenkwong/LearnKafka/raw/master/image/19.png)
...
### 29.Kafka案例\_API生产者分区策略测试

![](https://gitee.com/jallenkwong/LearnKafka/raw/master/image/20.png)

ProducerRecord类有许多构造函数，其中一个参数partition可指定分区

TODO:根据策略阐述，亲自设计分区策略测试，range和round-robin间的区别

### 30.Kafka案例\_API带自定义分区器的生成者
...
>
> From [kafka-console-sonsumer.bat](https://my.oschina.net/jallenkwong/blog/4449224#h2_9)
...
### 38.Kafka案例\_API自定义拦截器（案例测试）

![](https://gitee.com/jallenkwong/LearnKafka/raw/master/image/21.png)

### 39.Kafka案例\_监控Eagle的安装
...
* 运行
  * 运行ZooKeeper
  * 运行Kafka集群，另外运行kafka server前，需设置JMX\_PORT，否则Kafka Eagle 后台提示连接失败。执行命令行`set JMX_PORT=9999 & start bin\windows\kafka-server-start.bat config\server.properties`设置JMX\_PORT且运行Kafkaserver。在单节点开启Kafka集群，小心端口号冲突。
...
![](https://gitee.com/jallenkwong/LearnKafka/raw/master/image/22.png)

### 40.Kafka案例\_监控Eagle的使用
